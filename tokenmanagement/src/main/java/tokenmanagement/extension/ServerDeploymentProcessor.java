 ...
 */
public class ServerDeploymentProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        if (webContext == null) {
            throw new DeploymentUnitProcessingException("Can't determine web context/module for Tocken Management Server");
        }
    ...
    private void addConfiguration(DeploymentUnit deploymentUnit, AdapterConfigService configService) throws DeploymentUnitProcessingException {
