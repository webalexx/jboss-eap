 ...
 * @version $Revision: 1 $
 */
public class ProviderDeploymentProcessor implements DeploymentUnitProcessor {

//    AttachmentKey<ProviderManager> ATTACHMENT_KEY = AttachmentKey.create(ProviderManager.class);

    private static final Logger logger = Logger.getLogger(ProviderDeploymentProcessor.class);
    @Override
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        if (!ProviderDependencyProcessor.isKeycloakProviderDeployment(deploymentUnit)) return;
...
//        deploymentUnit.putAttachment(ATTACHMENT_KEY, pm);
    ...
    public ProviderDeploymentProcessor() {
        super();
    }
