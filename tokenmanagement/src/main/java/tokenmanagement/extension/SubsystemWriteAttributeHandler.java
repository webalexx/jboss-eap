 ...
 */
public class SubsystemWriteAttributeHandler extends ModelOnlyWriteAttributeHandler { //extends ReloadRequiredWriteAttributeHandler {

    public SubsystemWriteAttributeHandler(List<AttributeDefinition> definitions) {
        this(definitions.toArray(new AttributeDefinition[definitions.size()]));
    }

    public SubsystemWriteAttributeHandler(AttributeDefinition... definitions) {
        super(definitions);
    }
...
//        AttributeDefinition attribDef = SubsystemDefinition.lookup(attributeName);
